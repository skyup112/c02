...
//
//        Member 기업회원_계정 = new Member(null, "corp123123456789", "pass", "기업명", LocalDate.of(1980, 1, 1), "서울", "02-1234-5678", 기업회원);
...
//
//        Member 개인회원_계정 = new Member(null, "user123123456789", "password", "홍길동", LocalDate.of(1995, 5, 10), "부산", "010-5678-1234", 개인회원);
...
//        지원서.setFilePath("/resumes/user123233_resume.pdf");
